...
export const MessageBoxUI = observer((props) => {
    ...
    return (<Modal isOpen={true} contentLabel={""} ariaHideApp={false} style={{
			...
			{o.title != null &&
            <div style={E(styles.title, o.titleStyle)} onMouseDown={e => {
					...
					<TitleAsReactFunctionComp {...{ updateCallCount }}/>
					{/*TitleAsReactElements*/}
				</div>}
			{o.message != null &&
            <div style={E(styles.message, typeof o.message == "string" && { whiteSpace: "pre-wrap" }, o.messageStyle)}>
					<MessageAsReactFunctionComp {...{ updateCallCount }}/>
					{/*MessageAsReactElements*/}
				</div>}
			{(o.okButton || o.cancelButton || o.extraButtons) &&
            <div style={E(styles.buttonBar, o.buttonBarStyle)}>
					{o.okButton &&
                    <Button text="OK" {...o.okButtonProps} onClick={() => {
                            controller.PressOK();
                        }}/>}
					{o.cancelButton &&
					...
					{o.extraButtons != null &&
                    <o.extraButtons {...{ updateCallCount }}/>}
				</div>}
		</Modal>);
});
